...
from torch.optim.optimizers import SGD
from .ekfac import EKFAC


def add_train_args(parser):
    """ Initializes the argument parser for the projet """
    ...
    parser.add_argument('--optimizer', type=str, choices=['sgd', 'ekfac'],
                        help='which optimizer to use for training!')

    # EKFAC-specific hyperparameters
    parser.add_argument('eps', type=float, default=0.1,
                        help='dampening parameter for inverting k-factors')
    parser.add_argument('update_freq', type=int, default=1,
                        help='number of steps between k-factor updates')
